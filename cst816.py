...
fm.register(25, fm.fpioa.GPIOHS7, force=True) # CS
int_gpio = GPIO(GPIO.GPIOHS7, GPIO.IN, GPIO.PULL_DOWN)
#int_gpio.value(1)
...
while True:
    try:
        ...
        print("Pos:{},{}  Ges:{}  Press:{} Int:{}  dX:{}  dY:{}".format(
              x, y, gesture, pressed, bool(not int_gpio.value()), dx, dy))
        time.sleep_ms(50)
